...
NUM_CLASSES = 8
BATCH_SIZE = 16  # Increased batch size slightly as ResNet50 is smaller than B5
...
def main():
    ...
    train_dataset = BreakHisDataset(
        ...
        transform=get_resnet_train_transforms()
    )
    ...
    # --- Partial Freezing ---
    # Freeze early layers to preserve low-level features and prevent catastrophic forgetting.
    ...
    torch.save(best_model_wts, "models/best_resnet50_all_mag.pth")

    print(f"\nTraining finished.")
    print(f"Best validation accuracy: {best_val_acc:.4f}")
    print("Model saved to: models/best_resnet50_all_mag.pth")
